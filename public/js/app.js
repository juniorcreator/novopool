...
function () {
  ...
  _createClass(App, [{
    ...
    key: "macy_gallery",
    value: function macy_gallery() {
      if ($('.pool-gallery__gallery-wrap').length != 0) {
        macy__WEBPACK_IMPORTED_MODULE_0___default()(this.macy_params('.pool-gallery__gallery-wrap', 2, false, false, 18, 22, 2, 2, 2, 2));
      }
    }
  }, {
    key: "cut_eny_text",
    ...
    key: "check_window_width",
    value: function check_window_width() {// let prod_count = 2;
    ...
    value: function slider_images() {
      var img_slider = $('.images-slider .images-slider__wrap');
      img_slider.slick({
    ...
    key: "slider_companies",
    value: function slider_companies() {
      var companies_slider = $('.companies-slider .companies-slider__wrap');
    ...
    key: "slider_poular_category",
    value: function slider_poular_category() {
      var poular_category = $('.slide-popular-category .slide-popular-category__wrap');
...
__webpack_require__(/*! C:\Projects\work\mix\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Projects\work\mix\resources\sass\app.scss */"./resources/sass/app.scss");
